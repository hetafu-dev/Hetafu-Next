          ...
          <div className="py-12 md:py-20">
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
              <div className="flex-shrink-0 px-4 md:px-10 lg:w-1/3">
                <h1 className="text-4xl md:text-5xl font-bold text-primary-brown mb-4 leading-tight">Denta Bits</h1>
              ...
              <div className="w-full lg:w-2/3">
                <Image
                  src="/Images/Products/Bits/Dentabitspagetop.png"
                  alt="Bits Hero"
                  width={600}
                  height={400}
                  unoptimized
        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-10 py-12 md:py-20">
          <div className="flex flex-col sm:flex-row flex-wrap items-center justify-between gap-4 mb-10">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-[#887766] tracking-widest uppercase">1 Product</span>
            </div>
          </div>
