          ...
          <div className="py-12 md:py-20">
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
              <div className="flex-shrink-0 px-4 md:px-10 lg:w-1/3">
                <h1 className="text-4xl md:text-5xl font-bold text-primary-brown mb-4 leading-tight">Cute Mouthwash</h1>
              ...
              <div className="w-full lg:w-2/3">
                <Image
                  src="/Images/Products/CUTE/cutepagetop.png"
                  alt="Cute Hero"
                  width={600}
                  height={400}
                  unoptimized
